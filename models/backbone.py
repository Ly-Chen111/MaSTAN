...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        # print(backbone)
        # modified for offline running
        # backbone = torchvision.models.resnet50(replace_stride_with_dilation=[False, False, dilation], weights=is_main_process(), norm_layer=FrozenBatchNorm2d)
...
class Joiner(nn.Sequential):
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        # torch.Size([4, 256, 104, 160])
        # torch.Size([4, 512, 52, 80])
        # torch.Size([4, 1024, 26, 40])
        # torch.Size([4, 2048, 13, 20])
